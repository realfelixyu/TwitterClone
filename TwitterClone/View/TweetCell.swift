...
//  TwitterClone
//
//  Created by Felix Yu on 9/30/20.
...
//        profileImageView.anchor(top: topAnchor, left: leftAnchor, paddingTop: 12, paddingLeft: 8)
        ...
        contentView.addSubview(imageCaptionStack)
        ...
        addSubview(stack)
        stack.anchor(top: topAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 8, paddingLeft: 8, paddingRight: 12)
